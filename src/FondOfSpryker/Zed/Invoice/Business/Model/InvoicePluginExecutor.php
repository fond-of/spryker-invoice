...
{
    /**
     * @var array|\FondOfSpryker\Zed\InvoiceExtension\Dependency\Plugin\InvoicePreSavePluginInterface[]
     */
    protected $invoicePreSavePlugins;

    /**
     * @var array|\FondOfSpryker\Zed\InvoiceExtension\Dependency\Plugin\InvoicePostSavePluginInterface[]
     */
    protected $invoicePostSavePlugins;

    /**
     * @param \FondOfSpryker\Zed\InvoiceExtension\Dependency\Plugin\InvoicePreSavePluginInterface[] $invoicePreSavePlugins
     * @param \FondOfSpryker\Zed\InvoiceExtension\Dependency\Plugin\InvoicePostSavePluginInterface[] $invoicePostSavePlugins
     */
